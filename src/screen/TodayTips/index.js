...
class TodayTipsScreen extends Component {
    constructor(props){
        super(props)
        this.state = {
            isSelectedallButton: 1,
            isSelectedtipButton: 0,
        }
    };
    render(){
        return(
            <View style={styles.container}>
                {
                    ...
                    <View>
                        <View>
                            <Text style={styles.titleLabel}>Todays tips</Text>
                        </View>
                        ...
                        <ScrollView style={styles.notificationContainer}>
                            ...
                            <View>
                                <TipCardComponent background={back1} sporsImage={sport1} datetime="14/21/21 | 17/30" name="#scpobydoo" avatarImage={ avatar1 } team1={ FootballTeam[0] } team2={ FootballTeam[1] } odds="1.72" stakePrice="150.00" returnPrice="431.81" />
...
export default TodayTipsScreen;
